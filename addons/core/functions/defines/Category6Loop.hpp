        ...
        if ((_conditionsCountCategory6) > 0  || ((GETMVAR(ExtractionEnabled_6,false)) && {(GETMVAR(ExtractionForced_6,false))})) then {
            ...
            private _endConditionsCategory6PFHhandle = [{
                ...
                if (GETMVAR(ExtractionEnabled_6,false)) then {
                    ...
                    if (GVAR(ExtractionMarker_6) isEqualto "") exitwith {["","No marker entered for extract zone for Category 6!"] call FUNC(DebugMessageDetailed);};
                    if ((getMarkerColor GVAR(ExtractionMarker_6)) isEqualto "") exitwith {["","Invalid extract marker for Category 6!"] call FUNC(DebugMessageDetailed);};
