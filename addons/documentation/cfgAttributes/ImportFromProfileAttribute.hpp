class GVAR(FromProfileAttribute): Combo {
    attributeLoad = QUOTE(_this call FUNC(ImportFromProfileAttributeAttrLoad));
    attributeSave = "";
    class Controls: Controls {
        ...
        class Preview: ctrlButtonPictureKeepAspect {
            ...
            onMouseButtonClick = QUOTE(_this call FUNC(ImportSettings));
        };
    };
};
