...
def main():
    ...
    print("""
  ######################################
  # MMFW Development Environment Setup #
  ######################################

  This script will create your MMFW dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your MMFW project folder:
    [Arma 3 installation directory]\\{} => MMFW project folder
    P:\\{}                              => MMFW project folder
